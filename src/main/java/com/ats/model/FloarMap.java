...
public class FloarMap 
{
	...
	public String toString() {
		return "FloarMap [floarMapId=" + floarMapId + ", eventId=" + eventId + ", floarMap1=" + floarMap1
				+ ", floarMap2=" + floarMap2 + ", floarMap3=" + floarMap3 + ", floarMap4=" + floarMap4 + ", isUsed="
				+ isUsed + "]";
	}
