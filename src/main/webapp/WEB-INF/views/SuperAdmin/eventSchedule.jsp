				...
				<div class="box-content">
					...
					<div class="table-responsive" style="border: 0">
						<table class="table table-advance" id="table1">
							...
							<tbody>
								<c:forEach items="${getScheduleList}"
									var="getScheduleList" varStatus="count">
									...
									<tr class="table-flag-blue">
										...
										onclick="openDiv(${count.index+1})"	id="search"  >
												...
												<tbody>
													<c:forEach items="${getScheduleList.getEventSheduleDetailList}" var="getEventSheduleDetailList" varStatus="count">
					 
														<tr class="table-flag-blue">
															<td>${count.index+1}</td> 
															<td> ${getEventSheduleDetailList.topic}</td> 
															<td> ${getEventSheduleDetailList.venue}</td>
															<td> ${getEventSheduleDetailList.fromTime}</td>
															<td> ${getEventSheduleDetailList.toTime}</td>
															<td> ${getEventSheduleDetailList.speaker}</td>
															<td> ${getEventSheduleDetailList.seatsAvailable}</td>
															<td> ${getEventSheduleDetailList.remark}</td>
													</c:forEach>
