...
<body>
	...
	<div id="main-content">
		...
		<div class="page-title">
			<div>
				<h1>
					<i class="fa fa-file-o"></i>Organizer Package List
				</h1>
		...
		<div class="box" id="pending">
			<div class="box-title">
				<h3>
					<i class="fa fa-bars"></i>Organizer Package List
				</h3>
				<div class="box-tool">
									...
									<tr class="table-flag-blue">
										...
										<td>${packageList.pkgAmt}</td>	 
										 <td>${packageList.subDuration}</td>	
										  <td><a href="${pageContext.request.contextPath}/editOrganizerPackage/${packageList.pkgId}" data-toggle="tooltip" title="Edit"><span
												class="glyphicon glyphicon-edit"></span></a> 
											<a href="${pageContext.request.contextPath}/deleteOrganizerPackage/${packageList.pkgId}"
